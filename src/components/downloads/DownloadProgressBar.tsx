...
export function DownloadProgressBar() {
  ...
  return (
    <div className="fixed bottom-4 left-1/2 -translate-x-1/2 z-40 w-[420px] max-w-[92vw] px-4 py-3 rounded-2xl bg-[#1a1208]/95 backdrop-blur border border-[#E8B567]/40 shadow-[0_8px_32px_-8px_rgba(232,181,103,0.45)]">
