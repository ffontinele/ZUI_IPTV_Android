...
export function DownloadManagerModal({ onClose }: { onClose: () => void }) {
  ...
  return (
    <div className="fixed inset-0 z-50 grid place-items-center bg-black/80 backdrop-blur-sm p-4">
      <div ref={ref as any} className="w-[97vw] h-[94vh] max-w-[1600px] bg-[#14110e] border border-[#E8B567]/30 rounded-2xl shadow-[0_0_40px_-8px_#E8B567] overflow-hidden flex flex-col">
